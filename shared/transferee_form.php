<?php
// This file contains the shared form HTML and JavaScript for transferee registration
// It can be included by both admin and staff pages
?>

<div class="form-container">
    <div class="form-header">
        <h2><i class="fas fa-exchange-alt"></i> Add Transferee</h2>
        <p>Complete the form below to register a transferee student</p>
    </div>

    <form id="transfereeForm" action="<?php echo $form_action ?? 'transferee.php'; ?>" method="POST" enctype="multipart/form-data">
        <div class="form-content">
            ...
            <div class="upload-section">
                ...
                <div class="upload-grid">
                    ...
                    <div class="upload-item" data-type="tor">
                        <input type="file" name="torFile" accept=".pdf,.docx,.jpg,.png" style="display: none;">
                        <div class="upload-title">Transcript of Records</div>
                        <div class="upload-icon"><i class="fas fa-scroll"></i></div>
                        <div class="upload-text">Click to upload</div>
                    </div>

                    <div class="upload-item" data-type="honorable">
                        <input type="file" name="honorableFile" accept=".pdf,.docx,.jpg,.png" style="display: none;">
                        <div class="upload-title">Honorable Dismissal</div>
                        <div class="upload-icon"><i class="fas fa-award"></i></div>
                        <div class="upload-text">Click to upload</div>
                    </div>

                    <div class="upload-item" data-type="gradeslip">
                        <input type="file" name="gradeslipFile" accept=".pdf,.docx,.jpg,.png" style="display: none;">
                        <div class="upload-title">Grade Slip</div>
        ...
        <div class="submit-container">
            <button type="submit" class="submit-btn">
                <i class="fas fa-paper-plane"></i> Submit Transferee
            </button>
        </div>
    </form>
</div>
            ...
            try {
                ...
                if (data.status === 'success') {
                    ...
                    uploadItems.forEach(item => {
                        ...
                        switch(dataType) {
                            ...
                            case 'marriage':
                                ...
                                break;
                            case 'tor':
                                uploadIcon.className = 'fas fa-scroll';
                                break;
                            case 'honorable':
                                uploadIcon.className = 'fas fa-award';
                                break;
                            case 'gradeslip':
                    ...
                    await Swal.fire({
                        ...
                        text: 'The Student ID you entered already exists. Please check and try again.',
                        icon: 'warning',
